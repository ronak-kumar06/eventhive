    ...
    <div className="min-h-screen pt-32 pb-12 px-6 bg-[#F9F8F6]">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
          {/* Free Plan */}
          <div className="bg-[#F9F8F6]/5 border border-black/10 rounded-3xl p-8 backdrop-blur-xl relative">
            <h3 className="text-2xl font-bold mb-2">Basic</h3>
            <p className="text-zinc-900/50 mb-6">For small clubs and societies.</p>
            <div className="mb-6">
              <span className="text-4xl font-bold">$0</span>
              <span className="text-zinc-900/50">/month</span>
            </div>
            ...
            <button className="w-full py-3 rounded-full border border-black/20 hover:bg-[#F9F8F6]/10 transition-colors font-medium">
              Get Started
            </button>
          </div>
          ...
          <div className="bg-gradient-to-b from-blue-500/20 to-[#C1D5C0]/20 border border-blue-500/50 rounded-3xl p-8 backdrop-blur-xl relative transform md:-translate-y-4 shadow-[0_0_40px_rgba(59,130,246,0.15)]">
            <div className="absolute top-0 left-1/2 transform -translate-x-1/2 -translate-y-1/2">
              <span className="bg-blue-500 text-zinc-900 text-xs font-bold px-3 py-1 rounded-full uppercase tracking-wider">
                Most Popular
              </span>
            </div>
            <h3 className="text-2xl font-bold mb-2">Pro</h3>
            <p className="text-zinc-900/50 mb-6">For active campus organizations.</p>
            <div className="mb-6">
            ...
            <button className="w-full py-3 rounded-full bg-blue-500 hover:bg-blue-600 text-zinc-900 transition-colors font-medium">
              Upgrade to Pro
            </button>
          </div>
          ...
          <div className="bg-[#F9F8F6]/5 border border-black/10 rounded-3xl p-8 backdrop-blur-xl relative">
            ...
            <p className="text-zinc-900/50 mb-6">For universities and student unions.</p>
            <div className="mb-6">
