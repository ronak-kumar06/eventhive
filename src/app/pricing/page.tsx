      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
          ...
          <div className="bg-white/5 border border-white/10 rounded-3xl p-8 backdrop-blur-xl relative">
            ...
            <p className="text-white/50 mb-6">For small clubs and societies.</p>
            <div className="mb-6">
            ...
            <button className="w-full py-3 rounded-full border border-white/20 hover:bg-white/10 transition-colors font-medium">
              Get Started
            </button>
          </div>

          {/* Pro Plan */}
          <div className="bg-gradient-to-b from-blue-500/20 to-purple-500/20 border border-blue-500/50 rounded-3xl p-8 backdrop-blur-xl relative transform md:-translate-y-4 shadow-[0_0_40px_rgba(59,130,246,0.15)]">
            ...
            <p className="text-white/50 mb-6">For active campus organizations.</p>
            <div className="mb-6">
            ...
            <button className="w-full py-3 rounded-full bg-blue-500 hover:bg-blue-600 text-white transition-colors font-medium">
              Upgrade to Pro
            </button>
          </div>
          ...
          <div className="bg-white/5 border border-white/10 rounded-3xl p-8 backdrop-blur-xl relative">
            ...
            <p className="text-white/50 mb-6">For universities and student unions.</p>
            <div className="mb-6">
