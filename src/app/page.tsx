    ...
    <div className="relative min-h-screen overflow-hidden bg-[#F9F8F6]">
      ...
      <div className="relative z-10 flex flex-col items-center justify-center min-h-[90vh] px-6 text-center pt-24">
        ...
        >
          ...
          <div className="relative rounded-2xl border border-black/10 bg-[#F9F8F6]/5 p-2 backdrop-blur-xl overflow-hidden shadow-2xl">
            ...
            <div className="h-[400px] md:h-[600px] w-full rounded-xl bg-[#F9F8F6]/40 border border-black/5 overflow-hidden flex flex-col">
              {/* Fake UI Header */}
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {[
            ...
            <motion.div
              key={i}
              whileHover={{ y: -10 }}
              className="p-8 rounded-2xl bg-[#F9F8F6]/5 border border-black/10 backdrop-blur-sm"
            >
